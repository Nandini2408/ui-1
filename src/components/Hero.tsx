...
const Hero = () => {
  ...
  return (
    <section className="relative bg-dark-primary py-16 md:py-24 px-4 overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-dark-primary via-dark-primary to-dark-secondary/80 pointer-events-none" />
      
      {/* Animated background elements */}
      <div className="absolute top-1/3 left-1/4 w-64 h-64 bg-tech-green/5 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '8s' }} />
      <div className="absolute bottom-1/4 right-1/3 w-72 h-72 bg-tech-green/5 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '12s' }} />
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col space-y-8 animate-fade-in">
            {/* Badge */}
            <div className="inline-flex items-center self-start rounded-full bg-dark-secondary border border-border-dark px-3 py-1 text-sm text-tech-green">
            ...
            <div>
              <h1 className="text-5xl md:text-6xl font-bold text-text-primary leading-tight">
                ...
                <span className="block text-tech-green">Best Developers</span>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="border-tech-green border-2 text-tech-green hover:bg-dark-secondary hover:text-white px-8 py-6 h-auto text-lg shadow-lg shadow-tech-green/10 hover:shadow-tech-green/20 transition-all duration-200"
              >
            ...
            <div className="pt-6 border-t border-border-dark">
              ...
              <div className="flex flex-wrap gap-6 items-center">
                <div className="text-text-secondary hover:text-tech-green transition-colors">TechCorp</div>
                <div className="text-text-secondary hover:text-tech-green transition-colors">InnovateLabs</div>
                <div className="text-text-secondary hover:text-tech-green transition-colors">DevStudio</div>
                <div className="text-text-secondary hover:text-tech-green transition-colors">ByteWorks</div>
              </div>
            </div>
          </div>
          ...
          <div className="hidden lg:block">
            <div className="relative bg-dark-secondary rounded-lg border border-border-dark shadow-2xl shadow-tech-green/5 overflow-hidden">
              {/* Terminal header */}
              ...
              <div className="p-6 font-mono text-sm">
                <div className="flex items-center text-text-secondary mb-2">
                  <Code className="h-4 w-4 mr-2 text-tech-green" />
                  <span>Finding the perfect candidate:</span>
                </div>
                <pre className="text-text-primary">
                  <code className="text-tech-green">{typedText}</code>
              ...
              <div className="bg-dark-secondary border-t border-border-dark p-3 text-xs text-text-secondary flex justify-between">
                ...
                <span className="text-tech-green">Ready</span>
              </div>
            </div>
            
            {/* Floating elements */}
            <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-tech-green/10 rounded-full blur-xl"></div>
            <div className="absolute top-1/2 -right-12 transform -translate-y-1/2 w-24 h-24 bg-tech-green/5 rounded-full blur-xl"></div>
          </div>
        </div>
      </div>
    </section>
